...
;( function( window ) {
	...
	*************************************************************/
	...
	// appends to both the grid and the slideshow
	CBPGridGallery.prototype.append = function(gg, ss) {
		this.appendGrid(gg);
		this.appendSlideshow(ss);
	...
	CBPGridGallery.prototype.appendGrid = function(li) {
		var self=this;
		// add open slideshow on click

		this.grid.appendChild(li);
		$(li).hide().fadeIn(1000);
		this.gridItems[this.gridItems.length]=li;
		this.itemsCount = this.gridItems.length;
	}

	CBPGridGallery.prototype.appendSlideshow = function(li) {
		this.slideshow.appendChild(li);
		this.slideshowItems[this.slideshowItems.length]=li;
	}
